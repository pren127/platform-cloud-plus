...
import com.qhh.basic.database.datasource.BaseDynamicDataSourceAutoConfiguration;
import com.qhh.basic.database.properties.DatabaseProperties;
import com.qhh.platform.tenant.context.InitDatabaseOnStarted;
 ...
 * 下面的每个注解讲解：
 * <p>
 * ConditionalOnProperty:  platform.database.multiTenantType=DATASOURCE 时，加载这个类，并执行下面的注解
 ...
 * MapperScan：扫描 com.qhh.platform 包下标记了Repository 注解的类为 Mybatis 的代理接口
 * <p>
 *
 * @author qhh
