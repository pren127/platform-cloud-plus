/*
 ...
 Source Schema         : platform_defaults
...
VALUES (1339508377687949312, '1111-基础服务', 'root', 'root',
        'jdbc:mysql://127.0.0.1:3306/platform_base_ddddd?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true&nullCatalogMeansCurrent=true',
        'com.mysql.cj.jdbc.Driver', '2020-12-17 17:50:59', 3, '2021-01-03 20:21:30', 3);
INSERT INTO `c_datasource_config`
VALUES (1345706960036560896, '1111-扩展服务', 'root', 'root',
        'jdbc:mysql://127.0.0.1:3306/platform_extend_ddddd?serverTimezone=CTT&characterEncoding=utf8&useUnicode=true&useSSL=false&autoReconnect=true&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true',
...
VALUES (1, 'platform-base-executor', '基础库执行器', 0, NULL, '2021-01-09 23:08:34');
INSERT INTO `xxl_job_group`
VALUES (2, 'platform-extend-executor', '扩展库执行器', 0, NULL, '2021-01-09 23:08:34');
COMMIT;
...
VALUES (1, 'platform', '263addb7611158a2c3db7c164a20cc2f', 1, NULL);
COMMIT;
