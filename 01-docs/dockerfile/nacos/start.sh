...
docker stop platform_nacos
docker rm platform_nacos
docker run -idt --name platform_nacos --restart=always \
        ...
        -e MYSQL_SERVICE_HOST=192.168.2.178 -e MYSQL_SERVICE_DB_NAME=platform_nacos -e MYSQL_SERVICE_PORT=3218 \
