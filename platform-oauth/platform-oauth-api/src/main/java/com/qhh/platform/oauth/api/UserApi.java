...
import com.qhh.platform.oauth.api.hystrix.UserApiFallback;
 ...
 * @date 2019/07/02
 */
@FeignClient(name = "${platform.feign.oauth-server:platform-oauth-server}", fallback = UserApiFallback.class
