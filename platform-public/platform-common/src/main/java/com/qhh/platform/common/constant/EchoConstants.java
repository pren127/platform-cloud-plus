...
public class EchoConstants {
     ...
     * 数据字典项 feign查询类 全类名
     */
    public static final String DICTIONARY_ITEM_FEIGN_CLASS = "com.qhh.platform.oauth.api.DictionaryApi";
    /**
     * 数据字典项 service查询类
     */
     ...
     * 组织 feign查询类
     */
    public static final String ORG_ID_FEIGN_CLASS = "com.qhh.platform.oauth.api.OrgApi";
     ...
     * 用户 feign查询类
     */
    public static final String USER_ID_FEIGN_CLASS = "com.qhh.platform.oauth.api.UserApi";
     ...
     * 组织 feign查询类
     */
    public static final String STATION_ID_FEIGN_CLASS = "com.qhh.platform.oauth.api.StationApi";
