package com.qhh.platform.gateway.filter;
...
import com.qhh.basic.context.ContextConstants;
...
import com.qhh.basic.jwt.utils.JwtUtil;
import com.qhh.basic.utils.StrPool;
import com.qhh.platform.common.cache.common.TokenUserIdCacheKeyBuilder;
import com.qhh.platform.common.constant.BizConstant;
import com.qhh.platform.common.properties.IgnoreProperties;
...
import static com.qhh.basic.context.ContextConstants.BASIC_HEADER_KEY;
import static com.qhh.basic.context.ContextConstants.BEARER_HEADER_KEY;
import static com.qhh.basic.context.ContextConstants.JWT_KEY_CLIENT_ID;
import static com.qhh.basic.context.ContextConstants.JWT_KEY_TENANT;
import static com.qhh.basic.exception.code.ExceptionCode.JWT_NOT_LOGIN;
import static com.qhh.basic.exception.code.ExceptionCode.JWT_OFFLINE;
...
public class TokenContextFilter implements WebFilter, Ordered {
    ...
    @Value("${platform.database.multiTenantType:SCHEMA}")
    ...
    private Mono<Void> parseToken(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        if (isDev(token)) {
            authInfo = new AuthInfo().setAccount("platform").setUserId(2L)
