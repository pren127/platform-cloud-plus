package com.qhh.platform.gateway.controller;
 ...
 * 1，platform-ui/src/api/BlockList.js 所有的url增加 /gate 的前缀。 如： /gate/gateway/blocklist/page
 * 2，platform-ui/src/api/RateLimiter.js 所有的url增加 /gate 的前缀。 如： /gate/gateway/rateLimiter/page
 *
 * @author qhh
